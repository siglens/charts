...
Selector labels
*/}}
{{- define "siglens-query-server.labels" -}}
helm.sh/chart: {{ include "siglens.chart" . }}
{{ include "siglens-query-server.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
Selector labels
*/}}
{{- define "siglens-ingest-server.labels" -}}
helm.sh/chart: {{ include "siglens.chart" . }}
{{ include "siglens-ingest-server.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
...
Selector labels
*/}}
{{- define "siglens-query-server.selectorLabels" -}}
app.kubernetes.io/name: {{ include "siglens.name" . }}-query
...
Selector labels
*/}}
{{- define "siglens-ingest-server.selectorLabels" -}}
app.kubernetes.io/name: {{ include "siglens.name" . }}-ingest
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
...
{{/*
SigLens Selector labels
*/}}
{{- define "siglens.selectorLabels" -}}
app.kubernetes.io/name: {{ include "siglens.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
...
{{- define "siglens-license.name" -}}
{{- $licenseName := "" -}}
{{- if .Values.siglens -}}
  {{- if .Values.siglens.configs -}}
    {{- if .Values.siglens.configs.license -}}
      {{- $licenseName = .Values.siglens.configs.license -}}
    {{- end -}}
  {{- end -}}
{{- end -}}
{{- $licenseName | trim -}}
